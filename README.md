[Link To School Project](#using-python-for-determining-school-performance)
...
### <a id="#using-python-for-determining-school-performance"></a> Using Python For Determine School Performance
### Actions and Output Value  
